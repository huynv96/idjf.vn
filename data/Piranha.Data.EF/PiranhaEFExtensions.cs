...
public static class PiranhaEFExtensions
{
        ...
        ServiceLifetime scope = ServiceLifetime.Scoped) where T : DbContext, IDb
    {
        ...
        services.Add(new ServiceDescriptor(typeof(IApplyRepository), typeof(ApplyRepository), scope));
        services.Add(new ServiceDescriptor(typeof(IContactRepository), typeof(ContactRepository), scope));
