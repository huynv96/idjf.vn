...
namespace Piranha.Services
{
    public class PostService : IPostService
    {
        ...
        public Task<IEnumerable<DynamicPost>> GetAllByCategoryIdAsync(Guid categoryId, int? index = null, int? pageSize = null)
        {
            return GetAllByCategoryIdAsync<DynamicPost>(categoryId, index, pageSize);
        }
        ...
        public async Task<IEnumerable<T>> GetAllByCategoryIdAsync<T>(Guid categoryId, int? index = null, int? pageSize = null) where T : PostBase
        {
            if (index.HasValue && !pageSize.HasValue)
            {
                // No page size provided, use default archive size
            ...
            var models = new List<T>();
            var posts = await _repo.GetByCategory(categoryId, index, pageSize).ConfigureAwait(false);
            var pages = new List<PageInfo>();
