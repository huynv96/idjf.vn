...
namespace Piranha.Services
{
    public class ContactService : IContactService
    {
        ...
        public ContactService(IContactRepository repo, ISiteService siteService, ICache cache = null)
        {
            _repo = repo;
        ...
        public async Task<IEnumerable<Contact>> GetAllAsync(Guid? siteId = null)
        {
            if (!siteId.HasValue)
            {
