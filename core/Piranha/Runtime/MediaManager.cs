...
namespace Piranha.Runtime
{
    public class MediaManager
    {
        ...
        /// <summary>
        /// Gets/sets the currently accepted rar extensions.
        /// </summary>
        public MediaTypeList Rar { get; set; } = new MediaTypeList();

        /// <summary>
        /// Gets/sets the currently accepted zip extensions.
        /// </summary>
        public MediaTypeList Zip { get; set; } = new MediaTypeList();
        ...
        public bool IsSupported(string filename)
        {
            ...
            return Documents.ContainsExtension(extension) ||
                ...
                Rar.ContainsExtension(extension) ||
                Zip.ContainsExtension(extension);
        }
        ...
        public MediaType GetMediaType(string filename)
        {
            ...
            if (Rar.ContainsExtension(extension))
            {
                return MediaType.Rar;
            }
            if (Zip.ContainsExtension(extension))
            {
        ...
        public string GetContentType(string filename)
        {
            ...
            if ((item = Rar.SingleOrDefault(t => t.Extension == extension)) != null)
            {
                return item.ContentType;
            }
            if ((item = Zip.SingleOrDefault(t => t.Extension == extension)) != null)
            {
                return item.ContentType;
            }
