...
namespace Piranha
{
    ...
    public static class Utils
    {
        ...
        public static string GenerateSlug(string str, bool hierarchical = true)
        {
            ...
            {
                slug = slug.Replace(((char)i).ToString(), " ");
            }
            ...
            string strSlug = slug.Normalize(NormalizationForm.FormD);
            string str2 = regex.Replace(strSlug, string.Empty).Replace('đ', 'd').Replace('Đ', 'D');
